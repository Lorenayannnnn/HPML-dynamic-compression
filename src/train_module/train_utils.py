...
def create_trainer_args(configs, train_data_size: int):
    ...
    args = transformers.TrainingArguments(
        ...
        warmup_steps=int(train_data_size // training_args.batch_size * training_args.num_train_epochs * configs.training_args.warmup_percentage),
        ...
        eval_steps=5 if training_args.do_eval else None,
        save_steps=5,
